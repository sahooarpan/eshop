...
import { addItemToCart,removeItemFromCart,clearItemFromCart } from '../actions/cart'
...
export default connect(null,{addItemToCart,removeItemFromCart,clearItemFromCart})(CheckOutItem)
